...
if (index.includes('window.DATA_MATTERS_APP_VERSION = "v3.13.1"')) {
  throw new Error("目前仍是 v3.13.1。請先完成 v3.13.2 首頁更新。");
}
// v3.13.2 與部分套用後的 v3.13.3 都可以安全重跑。
...
applyTextReplacements("product-v3.js", [
  ['更偏向限制下的最佳安排', '更偏向在限制下找出更好的安排', '角色差異', false],
  ['更偏向金錢、風險與量化判斷', '更偏向用數字評估金錢與風險', '角色差異', false],
  ['享受最佳化', '喜歡找出更好的安排', '精簡理由', false],
  ['高度相符', '偏好很接近', '結果信心', false],
  ['你最像', '最接近你的方向', '結果主標', false],
  ['工作偏好匹配', '根據你的工作偏好', '結果區塊標籤', false],
  ['這個訊號來自你的工作內容偏好，不是科系或收入期待。', '這個理由只根據你對工作內容的偏好，不會看科系或收入期待。', '推薦理由說明', false],
  ['先認識真實職稱', '看看職場上的真實名稱', '工作名稱標籤', false],
  ['查看完整職涯輪廓', '查看完整結果', '結果摘要入口', false],
  ['了解你的工作偏好與技術投入。', '了解你偏好的工作方式與需要準備的技術。', '結果摘要說明', false],
  ['你的技術投入：', '你願意投入的技術學習：', '結果摘要標題', false],
  ['目前起點不決定適合度。', '目前的科系與基礎不會決定你是否適合。', '背景說明', false],
  ['可補強：', '可以先補強：', '背景說明', false],
  ['讀 5 份職缺', '讀 5 份真實職缺', '下一步', false],
  ['工作環境偏好 不影響職涯角色排名。', '工作環境偏好 不會改變推薦順序。', '環境說明', false],
  ['技術投入', '需要的技術學習', '角色比較標籤', false],
  ['適合的成就感', '常見的成就感', '角色比較標籤', false],
  ['最容易混淆', '常見誤解', '角色比較標籤']
]);
