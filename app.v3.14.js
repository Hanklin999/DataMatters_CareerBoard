...
const HomeCardFan = {
  ...
  layoutPreset(){
    ...
    if (width <= 480) {
      return [
        { x: -72, y: 10, r: -12, s: 0.9, z: 2 },
        { x: 0, y: 0, r: 0, s: 1.02, z: 5 },
        { x: 72, y: 10, r: 12, s: 0.9, z: 2 }
      ];
    }
    ...
    if (width <= 800) {
      return [
        { x: -148, y: 24, r: -18, s: 0.88, z: 1 },
        { x: -76, y: 10, r: -8, s: 0.96, z: 3 },
        { x: 0, y: 0, r: 0, s: 1.03, z: 6 },
        { x: 76, y: 10, r: 8, s: 0.96, z: 3 },
        { x: 148, y: 24, r: 18, s: 0.88, z: 1 }
      ];
    }
