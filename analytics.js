...
(function () {
  ...
  var enabled = !!(cfg.ANALYTICS_ENABLED && cfg.SUPABASE_URL && cfg.SUPABASE_ANON_KEY);
  if (!cfg.SUPABASE_URL || !cfg.SUPABASE_ANON_KEY) {
    if (cfg.ANALYTICS_ENABLED) console.warn("[analytics] Supabase 設定未填（analytics-config.js），使用分析已停用；網站功能不受影響。");
    enabled = false;
  }
