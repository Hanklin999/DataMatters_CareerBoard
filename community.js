...
(() => {
  "use strict";
  const CATEGORIES=["全部","職涯方向","科系與課程","實習與求職","技能學習","網站建議"];
  ...
  const Community={
    async load(force=false){
      ...
      try{
        const url=new URL(`${location.origin}${API_BASE}/community-read`);if(state.category!=="全部")url.searchParams.set("category",state.category);url.searchParams.set("sort",state.sort);
